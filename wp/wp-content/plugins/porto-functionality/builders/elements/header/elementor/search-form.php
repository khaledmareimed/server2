		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				array(
					...
					'description' => sprintf( __( 'To show %1$scategory filter%2$s, you must select one of the %3$sSearch Content Type%4$s.', 'porto-functionality' ), '<b>', '</b>', '<a href="' . porto_get_theme_option_url( 'search-type' ) . '" target="_blank">', '</a>' ),
				)
			);
